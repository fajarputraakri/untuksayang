...
footer.href = "https://www.instagram.com/fajarputraakri/";

document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Sayangnya Fajar", "Fajar ada pertanyaan nih buat sayang?", "question").then(function () {
    Swal.fire("Jawab yang jujur ya sayang!").then(function () {
      Swal.fire("Awas aja kalo sayang boong!!", "", "error").then(function () {

        const {
          value: name
        } = Swal.fire({
          title: 'Masukin dulu namanya sayang',
          input: 'text',
          inputLabel: '',
